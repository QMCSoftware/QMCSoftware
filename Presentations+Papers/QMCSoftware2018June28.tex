...
\vspace{-5ex}
\lstinputlisting[lastline = 13]{../MATLAB_Prototype/discreteDistribution.m}
\end{frame}

\begin{frame}[fragile]
\frametitle{Elements of the Community Software---Discrete Distributions}
\vspace{-5ex}
\lstinputlisting[linerange = {1-1,14-21}]{../MATLAB_Prototype/discreteDistribution.m}
\end{frame}

\begin{frame}[fragile]
\frametitle{Elements of the Community Software---Discrete IID Uniform}
\vspace{-5ex}
\lstinputlisting[lastline = 14]{../MATLAB_Prototype/IIDDistribution.m}
\end{frame}

\begin{frame}[fragile]
\frametitle{Elements of the Community Software---Discrete IID Uniform}
\vspace{-5ex}
\lstinputlisting[linerange = {1-1,16-30}]{../MATLAB_Prototype/IIDDistribution.m}
\end{frame}

\begin{frame}[fragile]
\frametitle{Elements of the Community Software---Functions}
\vspace{-5ex}
\lstinputlisting{../MATLAB_Prototype/fun.m}
\end{frame}

\begin{frame}[fragile]
\frametitle{Elements of the Community Software---Keister's Function}
\vspace{-5ex}
\lstinputlisting{../MATLAB_Prototype/KeisterFun.m}
\end{frame}

\begin{frame}[fragile]
\frametitle{Elements of the Community Software---StoppingCriteria}
\vspace{-5ex}
\lstinputlisting{../MATLAB_Prototype/stoppingCriterion.m}
\end{frame}

\begin{frame}[fragile]
\frametitle{Elements of the Community Software---CLTStopping}
\vspace{-5ex}
\lstinputlisting[lastline=12]{../MATLAB_Prototype/CLTStopping.m}
\end{frame}

\begin{frame}[fragile]
\frametitle{Elements of the Community Software---CLTStopping}
\vspace{-5ex}
\lstinputlisting[linerange={1-1,14-20}]{../MATLAB_Prototype/CLTStopping.m}
\end{frame}
...
\frametitle{Elements of the Community Software---CLTStopping}
\vspace{-5ex}
\lstinputlisting[linerange={1-1,20-34}]{../MATLAB_Prototype/CLTStopping.m}
\end{frame}
...
\frametitle{Elements of the Community Software---CLTStopping}
\vspace{-5ex}
\lstinputlisting[linerange={1-1,35-44}]{../MATLAB_Prototype/CLTStopping.m}
\end{frame}

\begin{frame}[fragile]
\frametitle{Elements of the Community Software---CLTStopping}
\vspace{-5ex}
\lstinputlisting[linerange={1-1,45-61}]{../MATLAB_Prototype/CLTStopping.m}
\end{frame}

\begin{frame}[fragile]
\frametitle{Elements of the Community Software---Integration}
\vspace{-5ex}
\lstinputlisting{../MATLAB_Prototype/integrate.m}
\end{frame}

\begin{frame}[fragile]
\frametitle{Elements of the Community Software---Integration Example}
\vspace{-5ex}
\lstinputlisting[lastline=6]{../MATLAB_Prototype/IntegrationExample.m}
...
\frametitle{Elements of the Community Software---Integration Example}
\vspace{-5ex}
\lstinputlisting[linerange={7-8}]{../MATLAB_Prototype/IntegrationExample.m}
...
\frametitle{Elements of the Community Software---Integration Example}
\vspace{-5ex}
\lstinputlisting[linerange={9-11}]{../MATLAB_Prototype/IntegrationExample.m}
...
\vspace{-5ex}
\lstinputlisting[linerange={13-18}]{../MATLAB_Prototype/IntegrationExample.m}
...
\vspace{-5ex}
\lstinputlisting[linerange={20-21}]{../MATLAB_Prototype/IntegrationExample.m}
...
\vspace{-5ex}
\lstinputlisting[linerange={23-24}]{../MATLAB_Prototype/IntegrationExample.m}
