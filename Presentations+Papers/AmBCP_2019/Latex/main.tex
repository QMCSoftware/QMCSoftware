...
\addtobeamertemplate{headline}{} 
{
	...
	\node [anchor=north west, inner sep=2cm] at (current page.north west) {\includegraphics[height=9cm]{images/MengerIITRedGray.eps}}; 
	\end{tikzpicture} 
}
...
{
	\begin{tikzpicture}[remember picture,overlay] 
	\node [anchor=north east, inner sep=2cm] at (current page.north east) {\includegraphics[height=9cm]{images/iit_high_res.png}}; 
	\end{tikzpicture} 
}
