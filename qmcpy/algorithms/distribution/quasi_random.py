...
class QuasiRandom(DiscreteDistribution):
    ...
    def gen_distrib(self, n, m, j=1):
        ...
        if type(self.true_distribution).__name__== 'Lattice': return self.get_RS_lattice_b2(n, m, j)
        elif type(self.true_distribution).__name__== 'Sobol': return self.get_RS_sobol_b2g(n, m, j)
