...
class CubQMCMLCont(_CubQMCML):
    ...
    AccumulateData (AccumulateData)
        ...
        mean_level      [10.052  0.183  0.102  0.053]
        var_level       [6.581e-05 5.669e-05 2.597e-05 1.360e-05]
        bias_estimate   0.029
        time_integrate  ...
    ...
    def __init__(self, integrand, abs_tol=.05, alpha=.01, rmse_tol=None, n_init=256, n_max=1e10, 
        ...
        super(CubQMCMLCont,self).__init__(allowed_levels=['adaptive-multi'],allowed_distribs=[AbstractLDDiscreteDistribution],allow_vectorized_integrals=False)
