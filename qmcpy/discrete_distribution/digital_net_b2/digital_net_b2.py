...
class DigitalNetB2(LD):
    ...
    DigitalNetB2 (DiscreteDistribution Object)
        ...
        entropy         7
        spawn_key       ()
    >>> DigitalNetB2(dimension=2,seed=9,generating_matrices=25,randomize=False).gen_samples(4,warn=False)
    array([[0.        , 0.        ],
           [0.9153298 , 0.77393498],
           [0.56485398, 0.38815503],
           [0.47963386, 0.64646497]])
    ...
    >>> DigitalNetB2(dimension=5,seed=15,generating_matrices=29,randomize=False).gen_samples(8,warn=False)
    array([[0.        , 0.        , 0.        , 0.        , 0.        ],
           [0.87491813, 0.38095715, 0.62583503, 0.59672158, 0.87669075],
           [0.73784391, 0.19364101, 0.61643422, 0.26045738, 0.13826295],
           [0.38711481, 0.31280693, 0.24206706, 0.85327026, 0.76190169],
           [0.41575705, 0.90252141, 0.11982592, 0.13782233, 0.30981811],
           [0.70931528, 0.52560121, 0.74454213, 0.73258863, 0.68455431],
           [0.83807918, 0.83828459, 0.5132186 , 0.38240091, 0.42268456],
           [0.03697163, 0.71532786, 0.13801492, 0.97326234, 0.548275  ]])
    ...
    def __init__(self, dimension=1, randomize=None, graycode=False, seed=None, 
        ...
        Args:
            ...
            generating_matrices (ndarray, str, or int): generating matricies or path to generating matrices.
