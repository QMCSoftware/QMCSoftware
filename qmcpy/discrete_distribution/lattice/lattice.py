...
class Lattice(LD):
    ...
    array([[0.62509547, 0.8972138 ],
           [0.12509547, 0.3972138 ],
           [0.87509547, 0.6472138 ],
           [0.37509547, 0.1472138 ]])
    >>> l.gen_samples(1)
    array([[0.62509547, 0.8972138 ]])
    >>> l
    ...
    >>> l.gen_samples(4)
    array([[0.87064561, 0.2183619 ],
           [0.37064561, 0.7183619 ],
           [0.12064561, 0.4683619 ],
           [0.62064561, 0.9683619 ]])
    >>> l
    Lattice (DiscreteDistribution Object)
        d               2^(1)
        dvec            [0 1]
    ...
    array([[0.   , 0.   , 0.   , 0.   ],
           ...
           [0.625, 0.125, 0.125, 0.375],
           [0.375, 0.875, 0.875, 0.625],
           [0.875, 0.375, 0.375, 0.125]])
    ...
    array([[[0.62509547, 0.8972138 , 0.77568569],
            ...
            [0.87509547, 0.6472138 , 0.52568569],
            [0.37509547, 0.1472138 , 0.02568569]],
    <BLANKLINE>
           [[0.22520719, 0.30016628, 0.87355345],
            [0.72520719, 0.80016628, 0.37355345],
            [0.47520719, 0.05016628, 0.62355345],
            [0.97520719, 0.55016628, 0.12355345]]])
    >>> Lattice(3,seed=7,generating_vector=25,replications=2).gen_samples(4)
    array([[[0.77568569, 0.22520719, 0.30016628],
            [0.27568569, 0.72520719, 0.80016628],
            [0.02568569, 0.47520719, 0.55016628],
            [0.52568569, 0.97520719, 0.05016628]],
    <BLANKLINE>
           [[0.87355345, 0.0052653 , 0.82122842],
            [0.37355345, 0.5052653 , 0.32122842],
            [0.12355345, 0.2552653 , 0.57122842],
            [0.62355345, 0.7552653 , 0.07122842]]])
