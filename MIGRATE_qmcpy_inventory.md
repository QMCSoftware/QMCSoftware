...
This file supports the **Content Inventory** section of `MIGRATE_qmcpy_checklist.md`. It is a working inventory, not a final redirect plan.
...
Confirmed by Kang Jiangrui on 2026-05-26:
...
No page has been approved for retirement yet. Candidate groups for collaborator review:

- WordPress draft content:
  - `https://qmcpy.org/?page_id=689`
  - `https://qmcpy.org/?p=1670`
  - `https://qmcpy.org/?p=1710`
- Non-must-preserve WordPress pages:
  - Donation
  - Dev Tools
  - Videos
  - duplicate Contributors page
- Old news/event/announcement posts not currently matched to GitHub Pages content.

### External URL / Backlink Candidates

Initial public search candidates found on 2026-05-26; this list is not exhaustive and needs collaborator review. Search queries included:
...
| External source | URL | Estimated importance | Notes / suggested handling |
|---|---|---|---|
...
Low-value directory/SEO results also appeared and are not expected to drive migration decisions unless collaborators say otherwise:
...
| https://qmcpy.org/2020/09/03/posters/ | A Collection of QMCPy Posters | publish |  | needs inventory decision |
| https://qmcpy.org/2020/09/03/pydata-chicago-talk/ | A Seminar at PyData Chicago | publish |  | needs inventory decision |
| https://qmcpy.org/2021/02/12/qmcpy-version-1-0/ | QMCPy Version 1.0 | publish |  | needs inventory decision |
| https://qmcpy.org/2021/02/25/quasi-monte-carlo-software-article/ | Quasi-Monte Carlo Software Article | publish |  | needs inventory decision |
...
| https://qmcpy.org/2021/03/11/monte-carlo-methods-2021/ | Monte Carlo Methods 2021 | publish |  | needs inventory decision |
| https://qmcpy.org/2021/04/27/a-presentation-at-iits-computational-mathematics-seminar/ | A Presentation at IIT's Computational Mathematics Seminar | publish |  | needs inventory decision |
| https://qmcpy.org/2021/04/27/a-talk-at-the-chicago-area-siam-student-conference/ | A Talk at the Chicago Area SIAM Student Conference | publish |  | needs inventory decision |
| https://qmcpy.org/2021/04/27/a-talk-at-the-great-lakes-siam-conference/ | A Talk at the Great Lakes SIAM Conference | publish |  | needs inventory decision |
...
| https://qmcpy.org/2021/06/04/elliptic-pde-demo/ | Elliptic PDE Demo | publish |  | needs inventory decision |
| https://qmcpy.org/2022/02/22/qmcpy-events-coming-soon/ | QMCPy Events Coming Soon | publish |  | needs inventory decision |
...
| https://qmcpy.org/2023/04/28/illinois-tech-receives-nsf-grant-to-offer-intensive-summer-research-program-in-computational-mathematics-and-data-science-for-undergraduates/ | Illinois Tech Receives NSF Grant to Offer Intensive Summer Research Program in Computational Mathematics and Data Science for Undergraduates | publish |  | needs inventory decision |
| https://qmcpy.org/2023/05/08/combining-the-expertise-of-the-stasasticians-and-a-commitment-to-esg-principles-to-deliver-comprehensive-wealth-management-and-investment/ | Combining the Expertise of the StaSASticians and a Commitment to ESG Principles to Deliver Comprehensive Wealth Management and Investment | publish |  | needs inventory decision |
| https://qmcpy.org/2023/05/13/boosting-numerical-efficiency-with-low-discrepancy-sampling-enhancing-estimation-and-integration-in-diverse-fields-from-fred-hickernell-and-the-qmcpy-library/ | Boosting Numerical Efficiency with Low Discrepancy Sampling: Enhancing Estimation and Integration in Diverse Fields from Fred Hickernell and the QMCPy Library | publish |  | needs inventory decision |
...
| https://qmcpy.org/2023/07/04/open-source-an-important-tool-to-advancing-science/ | Open Source Software: An Important Tool for Advancing Science | publish |  | needs inventory decision |
| https://qmcpy.org/2023/07/05/qmcpy-talks-at-the-14th-international-conference-on-monte-carlo-methods-and-applications/ | QMCPY talks at the 14th International Conference on Monte Carlo Methods and Applications | publish |  | needs inventory decision |
| https://qmcpy.org/2023/08/06/innovative-investment-tool-qualifies-students-for-international-hackathon/ | Innovative Investment Tool Qualifies Students for International Hackathon | publish |  | needs inventory decision |
| https://qmcpy.org/2023/08/28/from-speedy-simulations-to-trustworthy-ai-undergraduates-take-on-research-challenges-at-illinois-tech-for-the-summer/ | From Speedy Simulations to Trustworthy AI: Undergraduates Take on Research Challenges at Illinois Tech for the Summer | publish |  | needs inventory decision |
| https://qmcpy.org/2023/10/04/simplifying-uncertainty-modeling-by-handing-the-backend-modeling-with-um-bridge/ | Simplifying and Improving Uncertainty Quantification with UM-Bridge | publish |  | needs inventory decision |
| https://qmcpy.org/2024/05/13/exploring-the-frontiers-the-15th-international-conference-on-monte-carlo-methods-and-applications-mcm-2025-at-illinois-institute-of-technology/ | Exploring the Frontiers: The 15th International Conference on Monte Carlo Methods and Applications (MCM 2025) at Illinois Institute of Technology | publish |  | needs inventory decision |
| https://qmcpy.org/2024/05/13/karl-menger-graduate-teaching-assistant-award/ | Karl Menger Graduate Teaching Assistant Award | publish |  | needs inventory decision |
