...
To execute an individual testbook file, e.g., `tb_quickstart.py`, run the following command in a terminal:

```{bash}
    cd test/booktests && python -m pytest tb_quickstart.py -v
```
