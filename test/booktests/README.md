...
To execute an individual testbook file, e.g., `tb_JCMDS_Sorokin_2026.py`, run the following command in a terminal:

```{bash}
    cd test/booktests && python -m pytest tb_JCMDS_Sorokin_2026.py -v
```
