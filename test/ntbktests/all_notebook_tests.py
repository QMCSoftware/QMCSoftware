...
class NotebookTests(BaseNotebookTest):
    ...
    @testbook('../../demos/integration_examples.ipynb', execute=True, timeout=TB_TIMEOUT)
    ...
    @testbook('../../demos/lebesgue_integration.ipynb', execute=True, timeout=TB_TIMEOUT)
    def test_lebesgue_integration_notebook(self, tb):
        pass

    @testbook('../../demos/linear-scrambled-halton.ipynb', execute=True, timeout=TB_TIMEOUT)
    ...
    @testbook('../../demos/quasirandom_generators.ipynb', execute=True, timeout=TB_TIMEOUT)
    def test_quasirandom_generators_notebook(self, tb):
        pass

    @testbook('../../demos/quickstart.ipynb', execute=True, timeout=TB_TIMEOUT)
    def test_quickstart_notebook(self, tb):
        pass

    @testbook('../../demos/sample_scatter_plots.ipynb', execute=True, timeout=TB_TIMEOUT)
