...
| `unittests.yml` | `push` to `develop` or `master`; PR into `develop` or `master`; `workflow_dispatch` | `macos`, `ubuntu`, `windows`; Python `3.5` to `3.14` | <ul><li>Install test and optional extras</li><li>Run `unittests`</li></ul> |
