...
More plot examples can be seen in the [Linear Matrix Scrambling and Digital Shift for Halton notebook](https://github.com/QMCSoftware/QMCSoftware/blob/develop/demos/linear-scrambled-halton.ipynb).
...
3. Owen, A. B. & Pan, Z. Gain coefficients for scrambled Halton points.
   2023. [arXiv:2308.08035](https://arxiv.org/abs/2308.08035) [math.NA].
