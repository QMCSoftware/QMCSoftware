...
measure = Lebesgue(dimension=1, lower_bound=-2, upper_bound=2)
distrib = Lattice(rng_seed=7)
stop_criterion = CLTRep(distrib, measure,
                        abs_tol=2.5e-10, n_max=2**30)
sol, data_obj = integrate(integrand, measure,
                          distrib, stop_criterion)
