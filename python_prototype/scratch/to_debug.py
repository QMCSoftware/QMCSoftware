...
distribution = Lattice(dimension, replications=16, seed=7) # taking 16*2^20 samples
#distribution = Sobol(dimension, replications=16, seed=7) # taking 16*2^17 samples
