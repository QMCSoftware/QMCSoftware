import unittest
from numpy import array, int64, log, zeros, ndarray
...
class Test_IIDStdUniform(unittest.TestCase):
    ...
    def test_gen_samples(self):
        ...
        with self.subTest(): self.assertEqual(type(samples),ndarray)
        with self.subTest(): self.assertEqual(samples.shape,(1,2,3))
