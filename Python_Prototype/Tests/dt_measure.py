...
Constructing measure with properties:
    ...
    measure_list:
        ...
        measure_list[1] with properties:
            domainShape:
            domainCoord: []
            measureData: {'timeVector': array([0.0625, 0.125 , 0.1875, 0.25  , 0.3125, 0.375 , 0.4375, 0.5   ,
        ...
        measure_list[2] with properties:
            domainShape:
            domainCoord: []
            measureData: {'timeVector': array([0.015625, 0.03125 , 0.046875, 0.0625  , 0.078125, 0.09375 ,
